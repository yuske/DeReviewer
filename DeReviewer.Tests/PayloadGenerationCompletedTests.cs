...
namespace DeReviewer.Tests
{
    public class PayloadGenerationCompletedTests
    {
        ...
        {
            var type = typeof(KnowledgeBaseFake.BinaryFormatterPatternsFake);
            var methodName = nameof(KnowledgeBaseFake.BinaryFormatterPatternsFake.OnlyPayloadGenerationCall); 
